...
type
  ...
  ID3D10DepthStencilState=interface(ID3D10DeviceChild)
    ...
    procedure GetDesc
    (
      out Desc:TD3D10_DepthStencilDesc  
    ); stdcall;
  end;
  ...
  ID3D10RasterizerState=interface(ID3D10DeviceChild)
    ...
    procedure GetDesc
    (
      out Desc:TD3D10_RasterizerDesc  
    ); stdcall;
  end;
  ...
  ID3D10Resource=interface(ID3D10DeviceChild)
    ...
    procedure GetType
    (
      out RType:TD3D10_ResourceDimension  
    ); stdcall;
  ...
  ID3D10Texture2D=interface(ID3D10Resource)
    ...
    (
      ...
      MapType:TD3D10_Map;  
      MapFlags:LongWord;  
      out MappedTex2D:TD3D10_MappedTexture2D  
    ):HResult; stdcall;
  ...
  ID3D10Texture3D=interface(ID3D10Resource)
    ...
    (
      ...
      MapType:TD3D10_Map;  
      MapFlags:LongWord;  
      out MappedTex3D:TD3D10_MappedTexture3D  
    ):HResult; stdcall;
  ...
  ID3D10ShaderResourceView=interface(ID3D10View)
    ...
    procedure GetDesc
    (
      out Desc:TD3D10_ShaderResourceViewDesc  
    ); stdcall;
  end;
  ...
  ID3D10RenderTargetView=interface(ID3D10View)
    ...
    procedure GetDesc
    (
      out Desc:TD3D10_RenderTargetViewDesc  
    ); stdcall;
  end;
  ...
  ID3D10DepthStencilView=interface(ID3D10View)
    ...
    procedure GetDesc
    (
      out Desc:TD3D10_DepthStencilViewDesc  
    ); stdcall;
  end;
  ...
  ID3D10Device=interface(IUnknown)
    ...
    (
      StartSlot:LongWord;
      NumBuffers:LongWord;
      pConstantBuffers:PID3D10Buffer  
    ); stdcall;
    ...
    (
      StartSlot:LongWord;
      NumViews:LongWord;
      pShaderResourceViews:PID3D10ShaderResourceView
    ); stdcall;
    ...
    (
      ...
      StartIndexLocation:LongWord;  
      BaseVertexLocation:Integer;  
      StartInstanceLocation:LongWord  
    ); stdcall;

    procedure DrawInstanced
    (
      VertexCountPerInstance:LongWord;  
      InstanceCount:LongWord;  
      StartVertexLocation:LongWord;  
      StartInstanceLocation:LongWord  
    ); stdcall;
    ...
    (
      Shader:ID3D10GeometryShader  
    ); stdcall;

    procedure IASetPrimitiveTopology
    (
      Topology:TD3D10_PrimitiveTopology  
    ); stdcall;
    ...
    (
      NumViews:LongWord;
      pRenderTargetViews:PID3D10RenderTargetView;
    ...
    (
      DstResource:ID3D10Resource;  
      DstSubresource:LongWord;  
      DstX:LongWord;  
      DstY:LongWord;  
      DstZ:LongWord;  
      SrcResource:ID3D10Resource;  
    ...
    (
      out PixelShader:ID3D10PixelShader  
    ); stdcall;
    ...
    (
      out VertexShader:ID3D10VertexShader  
    ); stdcall;
    ...
    (
      out InputLayout:ID3D10InputLayout  
    ); stdcall;
    ...
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pIndexBuffer:PID3D10Buffer{$ELSE}out pIndexBuffer:ID3D10Buffer{$ENDIF};  
      Format:PTDXGI_Format;  
      Offset:PLongWord  
    ); stdcall;
    ...
    (
      out GeometryShader:ID3D10GeometryShader  
    ); stdcall;

    procedure IAGetPrimitiveTopology
    (
      out Topology:TD3D10_PrimitiveTopology  
    ); stdcall;
    ...
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pPredicate:PID3D10Predicate{$ELSE}out Predicate:ID3D10Predicate{$ENDIF};  
      pPredicateValue:PLongBool  
    ); stdcall;
    ...
    (
      NumViews:LongWord;
      pRenderTargetViews:PID3D10RenderTargetView;
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilView:PID3D10DepthStencilView{$ELSE}out DepthStencilView:ID3D10DepthStencilView{$ENDIF}  
    ); stdcall;

    procedure OMGetBlendState
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pBlendState:PID3D10BlendState{$ELSE}out BlendState:ID3D10BlendState{$ENDIF};  
      const BlendFactor:TColorArray;  
      pSampleMask:PLongWord  
    ); stdcall;

    procedure OMGetDepthStencilState
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilState:PID3D10DepthStencilState{$ELSE}out DepthStencilState:ID3D10DepthStencilState{$ENDIF};  
      pStencilRef:PLongWord  
    ); stdcall;
    ...
    (
      const Desc:TD3D10_BufferDesc;  
      pInitialData:PTD3D10_SubresourceData;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pBuffer:PID3D10Buffer{$ELSE}out Buffer:ID3D10Buffer{$ENDIF}  
    ):HResult; stdcall;

    function CreateTexture1D
    (
      const Desc:TD3D10_Texture1DDesc;  
      pInitialData:PTD3D10_SubresourceData;
      out Texture1D:ID3D10Texture1D  
    ):HResult; stdcall;

    function CreateTexture2D
    (
      const Desc:TD3D10_Texture2DDesc;  
      pInitialData:PTD3D10_SubresourceData;
      out Texture2D:ID3D10Texture2D  
    ):HResult; stdcall;

    function CreateTexture3D
    (
      const Desc:TD3D10_Texture3DDesc;  
      pInitialData:PTD3D10_SubresourceData;
      out Texture3D:ID3D10Texture3D  
    ):HResult; stdcall;

    function CreateShaderResourceView
    (
      Resource:ID3D10Resource;  
      pDesc:PTD3D10_ShaderResourceViewDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pSRView:PID3D10ShaderResourceView{$ELSE}out SRView:ID3D10ShaderResourceView{$ENDIF}  
    ):HResult; stdcall;

    function CreateRenderTargetView
    (
      Resource:ID3D10Resource;  
      pDesc:PTD3D10_RenderTargetViewDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pRTView:PID3D10RenderTargetView{$ELSE}out RTView:ID3D10RenderTargetView{$ENDIF}  
    ):HResult; stdcall;

    function CreateDepthStencilView
    (
      Resource:ID3D10Resource;  
      pDesc:PTD3D10_DepthStencilViewDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilView:PID3D10DepthStencilView{$ELSE}out DepthStencilView:ID3D10DepthStencilView{$ENDIF}  
    ):HResult; stdcall;

    function CreateInputLayout
    (
      pInputElementDescs:PTD3D10_InputElementDesc;
      NumElements:LongWord;
      pShaderBytecodeWithInputSignature:Pointer;  
      BytecodeLength:SIZE_T;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pInputLayout:PID3D10InputLayout{$ELSE}out InputLayout:ID3D10InputLayout{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      ...
      BytecodeLength:SIZE_T;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pVertexShader:PID3D10VertexShader{$ELSE}out VertexShader:ID3D10VertexShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      pShaderBytecode:Pointer;  
      BytecodeLength:SIZE_T;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pGeometryShader:PID3D10GeometryShader{$ELSE}out GeometryShader:ID3D10GeometryShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      pShaderBytecode:Pointer;  
      BytecodeLength:SIZE_T;  
      pSODeclaration:PTD3D10_SoDeclarationEntry;
      NumEntries:LongWord;
    ...
    (
      pShaderBytecode:Pointer;  
      BytecodeLength:SIZE_T;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pPixelShader:PID3D10PixelShader{$ELSE}out PixelShader:ID3D10PixelShader{$ENDIF}  
    ):HResult; stdcall;

    function CreateBlendState
    (
      const BlendStateDesc:TD3D10_BlendDesc;
      {$IFDEF UsePointersForOptionalOutputInterfaces}pBlendState:PID3D10BlendState{$ELSE}out BlendState:ID3D10BlendState{$ENDIF}  
    ):HResult; stdcall;

    function CreateDepthStencilState
    (
      const DepthStencilDesc:TD3D10_DepthStencilDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilState:PID3D10DepthStencilState{$ELSE}out DepthStencilState:ID3D10DepthStencilState{$ENDIF}  
    ):HResult; stdcall;

    function CreateRasterizerState
    (
      const RasterizerDesc:TD3D10_RasterizerDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pRasterizerState:PID3D10RasterizerState{$ELSE}out RasterizerState:ID3D10RasterizerState{$ENDIF}  
    ):HResult; stdcall;

    function CreateSamplerState
    (
      const SamplerDesc:TD3D10_SamplerDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pSamplerState:PID3D10SamplerState{$ELSE}out SamplerState:ID3D10SamplerState{$ENDIF}  
    ):HResult; stdcall;

    function CreateQuery
    (
      const QueryDesc:TD3D10_QueryDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pQuery:PID3D10Query{$ELSE}out Query:ID3D10Query{$ENDIF}  
    ):HResult; stdcall;

    function CreatePredicate
    (
      const PredicateDesc:TD3D10_QueryDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pPredicate:PID3D10Predicate{$ELSE}out Predicate:ID3D10Predicate{$ENDIF}  
    ):HResult; stdcall;

    function CreateCounter
    (
      const CounterDesc:TD3D10_CounterDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pCounter:PID3D10Counter{$ELSE}out Counter:ID3D10Counter{$ENDIF}  
    ):HResult; stdcall;

    function CheckFormatSupport
    (
      Format:TDXGI_Format;  
      out FormatSupport:LongWord  
    ):HResult; stdcall;
    ...
    (
      ...
      out NumQualityLevels:LongWord  
    ):HResult; stdcall;

    procedure CheckCounterInfo
    (
      out CounterInfo:TD3D10_CounterInfo  
    ); stdcall;

    function CheckCounter
    (
      const Desc:TD3D10_CounterDesc;  
      out _Type:TD3D10_CounterType;  
      out ActiveCounters:LongWord;  
      Name:PAnsiChar;
      pNameLength:PLongWord;
      Units:PAnsiChar;
      pUnitsLength:PLongWord;
      Description:PAnsiChar;
      pDescriptionLength:PLongWord
    ):HResult; stdcall;
...
var D3D10CreateDevice: function(Adapter:IDXGIAdapter;DriverType:TD3D10_DriverType;Software:HMODULE;Flags:LongWord;SDKVersion:LongWord;out Device:ID3D10Device):HResult; stdcall;
var D3D10CreateDeviceAndSwapChain: function(Adapter:IDXGIAdapter;DriverType:TD3D10_DriverType;Software:HMODULE;Flags:LongWord;SDKVersion:LongWord;pSwapChainDesc:PTDXGI_SwapChainDesc;out SwapChain:IDXGISwapChain;out Device:ID3D10Device):HResult; stdcall;
var D3D10CreateBlob: function(NumBytes:SIZE_T;out Buffer:ID3D10Blob):HResult; stdcall;
...
var D3D10CompileShader: function(pSrcData:PAnsiChar;SrcDataLen:SIZE_T;pFileName:PAnsiChar;const Defines:TD3D10_ShaderMacro;Include:ID3D10Include;pFunctionName:PAnsiChar;pProfile:PAnsiChar;Flags:LongWord;out Shader:ID3D10Blob;out ErrorMsgs:ID3D10Blob):HResult; stdcall;
var D3D10DisassembleShader: function(pShader:Pointer;BytecodeLength:SIZE_T;EnableColorCode:LongBool;pComments:PAnsiChar;out Disassembly:ID3D10Blob):HResult; stdcall;
var D3D10GetPixelShaderProfile: function(Device:ID3D10Device):PAnsiChar; stdcall;
var D3D10GetVertexShaderProfile: function(Device:ID3D10Device):PAnsiChar; stdcall;
var D3D10GetGeometryShaderProfile: function(Device:ID3D10Device):PAnsiChar; stdcall;
var D3D10ReflectShader: function(pShaderBytecode:Pointer;BytecodeLength:SIZE_T;out Reflector:ID3D10ShaderReflection):HResult; stdcall;
var D3D10PreprocessShader: function(pSrcData:PAnsiChar;SrcDataSize:SIZE_T;pFileName:PAnsiChar;const Defines:TD3D10_ShaderMacro;Include:ID3D10Include;out ShaderText:ID3D10Blob;out ErrorMsgs:ID3D10Blob):HResult; stdcall;
var D3D10GetInputSignatureBlob: function(pShaderBytecode:Pointer;BytecodeLength:SIZE_T;out SignatureBlob:ID3D10Blob):HResult; stdcall;
var D3D10GetOutputSignatureBlob: function(pShaderBytecode:Pointer;BytecodeLength:SIZE_T;out SignatureBlob:ID3D10Blob):HResult; stdcall;
var D3D10GetInputAndOutputSignatureBlob: function(pShaderBytecode:Pointer;BytecodeLength:SIZE_T;out SignatureBlob:ID3D10Blob):HResult; stdcall;
var D3D10GetShaderDebugInfo: function(pShaderBytecode:Pointer;BytecodeLength:SIZE_T;out DebugInfo:ID3D10Blob):HResult; stdcall;
...
var D3D10StateBlockMaskUnion: function
(
  const A:TD3D10_StateBlockMask;  
  const B:TD3D10_StateBlockMask;  
  out Result:TD3D10_StateBlockMask  
):HResult; stdcall;  

var D3D10StateBlockMaskIntersect: function
(
  const A:TD3D10_StateBlockMask;  
  const B:TD3D10_StateBlockMask;  
  out Result:TD3D10_StateBlockMask  
...
var D3D10StateBlockMaskDifference: function
(
  const A:TD3D10_StateBlockMask;  
  const B:TD3D10_StateBlockMask;  
  out Result:TD3D10_StateBlockMask  
...
var D3D10StateBlockMaskEnableCapture: function
(
  const Mask:TD3D10_StateBlockMask;  
  StateType:TD3D10_DeviceStateTypes;  
  RangeStart:LongWord;
  RangeLength:LongWord
):HResult; stdcall;  

var D3D10StateBlockMaskDisableCapture: function
(
  const Mask:TD3D10_StateBlockMask;  
  StateType:TD3D10_DeviceStateTypes;  
  RangeStart:LongWord;
...
var D3D10StateBlockMaskEnableAll: function
(
  const Mask:TD3D10_StateBlockMask  
):HResult; stdcall;  

var D3D10StateBlockMaskDisableAll: function
(
  const Mask:TD3D10_StateBlockMask  
):HResult; stdcall;  

var D3D10StateBlockMaskGetSetting: function
(
  const Mask:TD3D10_StateBlockMask;  
  StateType:TD3D10_DeviceStateTypes;
  Entry:LongWord
...
var D3D10CreateStateBlock: function
(
  Device:ID3D10Device;
  const StateBlockMask:TD3D10_StateBlockMask;  
...
type
  ...
  ID3D10EffectType=class // Cannot use 'interface' as the QueryInterface, AddRef and Release methods are missing.
    ...
    function GetDesc
    (
      const Desc:TD3D10_EffectTypeDesc  
  ...
  ID3D10EffectVariable=class // Cannot use 'interface' as the QueryInterface, AddRef and Release methods are missing.
    ...
    function GetDesc
    (
      const Desc:TD3D10_EffectVariableDesc  
    ):HResult; virtual; stdcall; abstract;
  ...
  ID3D10EffectShaderVariable=class // Cannot use 'interface' as the QueryInterface, AddRef and Release methods are missing.(ID3D10EffectVariable)
    ...
    (
      ...
      out Desc:TD3D10_EffectShaderDesc  
    ):HResult; virtual; stdcall; abstract;
  ...
  ID3D10EffectPass=class // Cannot use 'interface' as the QueryInterface, AddRef and Release methods are missing.
    ...
    function GetDesc
    (
      const Desc:TD3D10_PassDesc  
    ):HResult; virtual; stdcall; abstract;

    function GetVertexShaderDesc
    (
      out Desc:TD3D10_PassShaderDesc  
    ):HResult; virtual; stdcall; abstract;
    ...
    (
      out StateBlockMask:TD3D10_StateBlockMask  
    ):HResult; virtual; stdcall; abstract;
  end;
  ...
  ID3D10EffectTechnique=class // Cannot use 'interface' as the QueryInterface, AddRef and Release methods are missing.
    ...
    function GetDesc
    (
      const Desc:TD3D10_TechniqueDesc  
    ):HResult; virtual; stdcall; abstract;
...
var D3D10CompileEffectFromMemory: function(pData:Pointer;DataLength:SIZE_T;pSrcFileName:PAnsiChar;pDefines:PTD3D10_ShaderMacro;Include:ID3D10Include;HLSLFlags:LongWord;FXFlags:LongWord;out CompiledEffect:ID3D10Blob;out Errors:ID3D10Blob):HResult; stdcall;
var D3D10CreateEffectFromMemory: function(pData:Pointer;DataLength:SIZE_T;FXFlags:LongWord;Device:ID3D10Device;EffectPool:ID3D10EffectPool;out Effect:ID3D10Effect):HResult; stdcall;
var D3D10CreateEffectPoolFromMemory: function(pData:Pointer;DataLength:SIZE_T;FXFlags:LongWord;Device:ID3D10Device;out EffectPool:ID3D10EffectPool):HResult; stdcall;
var D3D10DisassembleEffect: function(Effect:ID3D10Effect;EnableColorCode:LongBool;out Disassembly:ID3D10Blob):HResult; stdcall;
