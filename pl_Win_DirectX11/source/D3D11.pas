...
type
  ...
  ID3D11DepthStencilState=interface(ID3D11DeviceChild)
    ...
    procedure GetDesc
    (
      out Desc:TD3D11_DepthStencilDesc  
    ); stdcall;
  end;
  ...
  ID3D11RasterizerState=interface(ID3D11DeviceChild)
    ...
    procedure GetDesc
    (
      out Desc:TD3D11_RasterizerDesc  
    ); stdcall;
  end;
  ...
  ID3D11Resource=interface(ID3D11DeviceChild)
    ...
    procedure GetType
    (
      out ResourceDimension:TD3D11_ResourceDimension  
    ); stdcall;
  ...
  ID3D11ShaderResourceView=interface(ID3D11View)
    ...
    procedure GetDesc
    (
      out Desc:TD3D11_ShaderResourceViewDesc  
    ); stdcall;
  end;
  ...
  ID3D11RenderTargetView=interface(ID3D11View)
    ...
    procedure GetDesc
    (
      out Desc:TD3D11_RenderTargetViewDesc  
    ); stdcall;
  end;
  ...
  ID3D11DepthStencilView=interface(ID3D11View)
    ...
    procedure GetDesc
    (
      out Desc:TD3D11_DepthStencilViewDesc  
    ); stdcall;
  end;
  ...
  ID3D11UnorderedAccessView=interface(ID3D11View)
    ...
    procedure GetDesc
    (
      out Desc:TD3D11_UnorderedAccessViewDesc  
    ); stdcall;
  end;
  ...
  ID3D11ClassInstance=interface(ID3D11DeviceChild)
    ...
    (
      out Linkage:ID3D11ClassLinkage  
    ); stdcall;

    procedure GetDesc
    (
      out Desc:TD3D11_ClassInstanceDesc  
    ); stdcall;
  ...
  ID3D11ClassLinkage=interface(ID3D11DeviceChild)
    ...
    (
      pClassInstanceName:PAnsiChar;  
      InstanceIndex:LongWord;  
      out Instance:ID3D11ClassInstance  
    ):HResult; stdcall;

    function CreateClassInstance
    (
      pClassTypeName:PAnsiChar;  
      ConstantBufferOffset:LongWord;  
      ConstantVectorOffset:LongWord;  
      TextureOffset:LongWord;  
      SamplerOffset:LongWord;  
      out Instance:ID3D11ClassInstance  
    ):HResult; stdcall;
  end;
  ...
  ID3D11DeviceContext=interface(ID3D11DeviceChild)
    ...
    (
      StartSlot:LongWord;  
      NumBuffers:LongWord;  
      pConstantBuffers:PID3D11Buffer
    ); stdcall;
    ...
    (
      StartSlot:LongWord;  
      NumViews:LongWord;  
      pShaderResourceViews:PID3D11ShaderResourceView
    ); stdcall;

    procedure PSSetShader
    (
      PixelShader:ID3D11PixelShader;  
      pClassInstances:PID3D11ClassInstance;
    ...
    (
      ...
      MapType:TD3D11_Map;  
      MapFlags:LongWord;  
      out MappedResource:TD3D11_MappedSubresource  
    ):HResult; stdcall;
    ...
    (
      Topology:TD3D11_PrimitiveTopology  
    ); stdcall;
    ...
    (
      NumViews:LongWord;
      pRenderTargetViews:PID3D11RenderTargetView;
    ...
    (
      ...
      pRenderTargetViews:PID3D11RenderTargetView;
      DepthStencilView:ID3D11DepthStencilView;  
      UAVStartSlot:LongWord;  
      NumUAVs:LongWord;  
      pUnorderedAccessViews:PID3D11UnorderedAccessView;
      pUAVInitialCounts:PLongWord
    ); stdcall;
    ...
    (
      BufferForArgs:ID3D11Buffer;  
      AlignedByteOffsetForArgs:LongWord  
    ); stdcall;
    ...
    procedure Dispatch
    (
      ThreadGroupCountX:LongWord;  
      ThreadGroupCountY:LongWord;  
      ThreadGroupCountZ:LongWord  
    ); stdcall;
    ...
    (
      DstBuffer:ID3D11Buffer;  
      DstAlignedByteOffset:LongWord;  
      SrcView:ID3D11UnorderedAccessView  
    ); stdcall;
    ...
    (
      ...
      const Values:TQuadArray_UInt  
    ); stdcall;

    procedure ClearUnorderedAccessViewFloat
    (
      UnorderedAccessView:ID3D11UnorderedAccessView;  
      const Values:TQuadArray_Float  
    ); stdcall;
    ...
    (
      DomainShader:ID3D11DomainShader;  
      pClassInstances:PID3D11ClassInstance;
      NumClassInstances:LongWord
    ); stdcall;
    ...
    (
      out PixelShader:ID3D11PixelShader;  
      pClassInstances:PID3D11ClassInstance;  
      pNumClassInstances:PLongWord  
    ); stdcall;
    ...
    (
      out VertexShader:ID3D11VertexShader;  
      pClassInstances:PID3D11ClassInstance;  
      pNumClassInstances:PLongWord  
    ); stdcall;
    ...
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pIndexBuffer:PID3D11Buffer{$ELSE}out pIndexBuffer:ID3D11Buffer{$ENDIF};  
    ...
    (
      out GeometryShader:ID3D11GeometryShader;  
      pClassInstances:PID3D11ClassInstance;  
      pNumClassInstances:PLongWord  
    ); stdcall;
    ...
    (
      out Topology:TD3D11_PrimitiveTopology  
    ); stdcall;
    ...
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pPredicate:PID3D11Predicate{$ELSE}out Predicate:ID3D11Predicate{$ENDIF};  
    ...
    (
      NumViews:LongWord;
      pRenderTargetViews:PID3D11RenderTargetView;
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilView:PID3D11DepthStencilView{$ELSE}out DepthStencilView:ID3D11DepthStencilView{$ENDIF}  
    ); stdcall;
    ...
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pBlendState:PID3D11BlendState{$ELSE}out BlendState:ID3D11BlendState{$ENDIF};  
      const BlendFactor:TColorArray;  
    ...
    (
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilState:PID3D11DepthStencilState{$ELSE}out DepthStencilState:ID3D11DepthStencilState{$ENDIF};  
    ...
    (
      out HullShader:ID3D11HullShader;  
      pClassInstances:PID3D11ClassInstance;  
      pNumClassInstances:PLongWord  
    ); stdcall;
    ...
    (
      out DomainShader:ID3D11DomainShader;  
      pClassInstances:PID3D11ClassInstance;  
      pNumClassInstances:PLongWord  
    ); stdcall;
    ...
    (
      out ComputeShader:ID3D11ComputeShader;  
      pClassInstances:PID3D11ClassInstance;  
      pNumClassInstances:PLongWord  
    ); stdcall;
    ...
    (
      ...
      {$IFDEF UsePointersForOptionalOutputInterfaces}pCommandList:PID3D11CommandList{$ELSE}out CommandList:ID3D11CommandList{$ENDIF}  
    ):HResult; stdcall;
  end;
  ...
  ID3D11Device=interface(IUnknown)
    ...
    (
      const Desc:TD3D11_BufferDesc;  
      pInitialData:PTD3D11_SubresourceData;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pBuffer:PID3D11Buffer{$ELSE}out Buffer:ID3D11Buffer{$ENDIF}  
    ):HResult; stdcall;

    function CreateTexture1D
    (
      const Desc:TD3D11_Texture1DDesc;  
      pInitialData:PTD3D11_SubresourceData;
      {$IFDEF UsePointersForOptionalOutputInterfaces}pTexture1D:PID3D11Texture1D{$ELSE}out Texture1D:ID3D11Texture1D{$ENDIF}  
    ):HResult; stdcall;

    function CreateTexture2D
    (
      const Desc:TD3D11_Texture2DDesc;  
      pInitialData:PTD3D11_SubresourceData;
      {$IFDEF UsePointersForOptionalOutputInterfaces}pTexture2D:PID3D11Texture2D{$ELSE}out Texture2D:ID3D11Texture2D{$ENDIF}  
    ):HResult; stdcall;

    function CreateTexture3D
    (
      const Desc:TD3D11_Texture3DDesc;  
      pInitialData:PTD3D11_SubresourceData;
      {$IFDEF UsePointersForOptionalOutputInterfaces}pTexture3D:PID3D11Texture3D{$ELSE}out Texture3D:ID3D11Texture3D{$ENDIF}  
    ):HResult; stdcall;

    function CreateShaderResourceView
    (
      Resource:ID3D11Resource;  
      pDesc:PTD3D11_ShaderResourceViewDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pSRView:PID3D11ShaderResourceView{$ELSE}out SRView:ID3D11ShaderResourceView{$ENDIF}  
    ):HResult; stdcall;

    function CreateUnorderedAccessView
    (
      Resource:ID3D11Resource;  
      pDesc:PTD3D11_UnorderedAccessViewDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pUAView:PID3D11UnorderedAccessView{$ELSE}out UAView:ID3D11UnorderedAccessView{$ENDIF}  
    ):HResult; stdcall;

    function CreateRenderTargetView
    (
      Resource:ID3D11Resource;  
      pDesc:PTD3D11_RenderTargetViewDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pRTView:PID3D11RenderTargetView{$ELSE}out RTView:ID3D11RenderTargetView{$ENDIF}  
    ):HResult; stdcall;

    function CreateDepthStencilView
    (
      Resource:ID3D11Resource;  
      pDesc:PTD3D11_DepthStencilViewDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilView:PID3D11DepthStencilView{$ELSE}out DepthStencilView:ID3D11DepthStencilView{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      ...
      {$IFDEF UsePointersForOptionalOutputInterfaces}pInputLayout:PID3D11InputLayout{$ELSE}out InputLayout:ID3D11InputLayout{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      ...
      BytecodeLength:SIZE_T;  
      ClassLinkage:ID3D11ClassLinkage;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pVertexShader:PID3D11VertexShader{$ELSE}out VertexShader:ID3D11VertexShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      ...
      BytecodeLength:SIZE_T;  
      ClassLinkage:ID3D11ClassLinkage;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pGeometryShader:PID3D11GeometryShader{$ELSE}out GeometryShader:ID3D11GeometryShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      pShaderBytecode:Pointer;  
      BytecodeLength:SIZE_T;  
      pSODeclaration:PTD3D11_SoDeclarationEntry; 
      NumEntries:LongWord; 
      pBufferStrides:PLongWord; 
      NumStrides:LongWord; 
    ...
    (
      ...
      BytecodeLength:SIZE_T;  
      ClassLinkage:ID3D11ClassLinkage;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pPixelShader:PID3D11PixelShader{$ELSE}out PixelShader:ID3D11PixelShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      ...
      BytecodeLength:SIZE_T;  
      ClassLinkage:ID3D11ClassLinkage;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pHullShader:PID3D11HullShader{$ELSE}out HullShader:ID3D11HullShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      ...
      BytecodeLength:SIZE_T;  
      ClassLinkage:ID3D11ClassLinkage;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDomainShader:PID3D11DomainShader{$ELSE}out DomainShader:ID3D11DomainShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      ...
      BytecodeLength:SIZE_T;  
      ClassLinkage:ID3D11ClassLinkage;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pComputeShader:PID3D11ComputeShader{$ELSE}out ComputeShader:ID3D11ComputeShader{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      const BlendStateDesc:TD3D11_BlendDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pBlendState:PID3D11BlendState{$ELSE}out BlendState:ID3D11BlendState{$ENDIF}  
    ):HResult; stdcall;

    function CreateDepthStencilState
    (
      const DepthStencilDesc:TD3D11_DepthStencilDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDepthStencilState:PID3D11DepthStencilState{$ELSE}out DepthStencilState:ID3D11DepthStencilState{$ENDIF}  
    ):HResult; stdcall;

    function CreateRasterizerState
    (
      const RasterizerDesc:TD3D11_RasterizerDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pRasterizerState:PID3D11RasterizerState{$ELSE}out RasterizerState:ID3D11RasterizerState{$ENDIF}  
    ):HResult; stdcall;

    function CreateSamplerState
    (
      const SamplerDesc:TD3D11_SamplerDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pSamplerState:PID3D11SamplerState{$ELSE}out SamplerState:ID3D11SamplerState{$ENDIF}  
    ):HResult; stdcall;

    function CreateQuery
    (
      const QueryDesc:TD3D11_QueryDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pQuery:PID3D11Query{$ELSE}out Query:ID3D11Query{$ENDIF}  
    ):HResult; stdcall;

    function CreatePredicate
    (
      const PredicateDesc:TD3D11_QueryDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pPredicate:PID3D11Predicate{$ELSE}out Predicate:ID3D11Predicate{$ENDIF}  
    ):HResult; stdcall;

    function CreateCounter
    (
      const CounterDesc:TD3D11_CounterDesc;  
      {$IFDEF UsePointersForOptionalOutputInterfaces}pCounter:PID3D11Counter{$ELSE}out Counter:ID3D11Counter{$ENDIF}  
    ):HResult; stdcall;

    function CreateDeferredContext
    (
      ContextFlags:LongWord;
      {$IFDEF UsePointersForOptionalOutputInterfaces}pDeferredContext:PID3D11DeviceContext{$ELSE}out DeferredContext:ID3D11DeviceContext{$ENDIF}  
    ):HResult; stdcall;
    ...
    (
      out CounterInfo:TD3D11_CounterInfo  
    ); stdcall;

    function CheckCounter
    (
      const Desc:TD3D11_CounterDesc;  
      out _Type:TD3D11_CounterType;  
    ...
    (
      out ImmediateContext:ID3D11DeviceContext  
    ); stdcall;
...
var D3D11CreateDevice: function
(
  Adapter:IDXGIAdapter;  
  DriverType:TD3D_DriverType;
  Software:HMODULE;
  Flags:LongWord;
  pFeatureLevels:PTD3D_FeatureLevel;  
  FeatureLevels:LongWord;
  SDKVersion:LongWord;
  {$IFDEF UsePointersForOptionalOutputInterfaces}pDevice:PID3D11Device{$ELSE}out Device:ID3D11Device{$ENDIF};  
  pFeatureLevel:PTD3D_FeatureLevel;  
  {$IFDEF UsePointersForOptionalOutputInterfaces}pImmediateContext:PID3D11DeviceContext{$ELSE}out ImmediateContext:ID3D11DeviceContext{$ENDIF}  
):HResult; stdcall;  

var D3D11CreateDeviceAndSwapChain: function
(
  Adapter:IDXGIAdapter;  
  DriverType:TD3D_DriverType;
  Software:HMODULE;
  ...
  {$IFDEF UsePointersForOptionalOutputInterfaces}pSwapChain:PIDXGISwapChain{$ELSE}out SwapChain:IDXGISwapChain{$ENDIF};  
  {$IFDEF UsePointersForOptionalOutputInterfaces}pDevice:PID3D11Device{$ELSE}out Device:ID3D11Device{$ENDIF};  
  pFeatureLevel:PTD3D_FeatureLevel;  
  {$IFDEF UsePointersForOptionalOutputInterfaces}pImmediateContext:PID3D11DeviceContext{$ELSE}out ImmediateContext:ID3D11DeviceContext{$ENDIF}  
):HResult; stdcall;  
...
type
  ...
  ID3D11InfoQueue=interface(IUnknown)
    ...
    (
      const Filter:TD3D11_InfoQueueFilter  
    ):HResult; stdcall;

    function GetStorageFilter
    (
      pFilter:PTD3D11_InfoQueueFilter;
