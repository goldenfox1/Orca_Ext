...
type TDumpLevel = (dlTerseDump, dlMediumDump, dlMaximumDump);
    ...
    // Database type settings
     ...
     PXDataAppName = PAnsiChar;

     PXDataString = PAnsiChar;
