...
uses Classes, Types3DS, orca_scene2d;
...
type TFile3DS = class;
     ...
     public
       ...
       constructor CreateFromFile(Stream: TStream); virtual;
       destructor Destroy; override;
       procedure ClearLists;
...
// CreateFromFile
//
constructor TFile3DS.CreateFromFile(Stream: TStream);
begin
   Create;
//   FFileName := FileName;
   FStream := Stream;
...
function TFile3DS.ReadString: PAnsiChar;
var
   Len, LB: Integer;
   Buffer: AnsiString;
begin
...
begin
  ...
  FStream.ReadBuffer(Result, SizeOf(Result));
  {$ifdef FPC_BIG_ENDIAN}
  ReverseBytes(@Result.X, 4);
  ReverseBytes(@Result.Y, 4);
  ReverseBytes(@Result.Z, 4);
  {$endif}
end;
      ...
      POINT_ARRAY:
        begin
          ...
          begin
            ...
            begin
              ReverseBytes(@PointList[I].X, 4);
              ReverseBytes(@PointList[I].Y, 4);
              ReverseBytes(@PointList[I].Z, 4);
            end;
            {$endif}
          end;
        end;
